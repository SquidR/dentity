...
local entityTable = Spawner.createEntity({
    CustomName = "Creeper", -- Custom name of your entity
    ...
    CustomDialog = {"Looks like you died to the one you call 'Creeper'", "He is very slow, so be careful and watch out for the rebound."}, -- Custom death message
})
